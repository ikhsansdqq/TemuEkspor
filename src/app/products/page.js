        ...
        <div>
          ...
          <main className="container mx-auto py-6">
            <div className='md:flex md:justify-between mb-4 md:mb-0'>
                ...
                <div>
                    <button id='button-1' className="bg-blue-950 text-white py-3 px-8 rounded flex gap-3" onClick={checkoutCart}><IconShoppingBag stroke={2} />Checkout ({cartItems})</button>
                </div>
            </div>
