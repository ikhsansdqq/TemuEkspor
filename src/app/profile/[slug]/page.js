...
export default function Profile() {
    const dummy = ['ikhsansdq', 'ridhosunation', 'naruto'];
    const username = dummy[0]; // Change the index to select the desired username
    const link = `localhost:3000/profile/${username}`;
    console.log(link);
    return (        
        <div>
